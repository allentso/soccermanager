...
local Dashboard = {}
local ObjectivesSheets = require("scripts/ui/screens/dashboard/objectives_sheets")
local NtView = require("scripts/ui/screens/dashboard/nt_view")
...
function Dashboard._showObjectivesDetail(gameState)
    return ObjectivesSheets.showDetail(gameState)
end

function Dashboard._showObjectiveSelection(gameState, initSelected)
    return ObjectivesSheets.showSelection(gameState, initSelected)
end

function Dashboard._showNTCoachGuidance(gameState)
    return NtView.showCoachGuidance(gameState)
end

function Dashboard._buildNTMatchHero(gameState)
    return NtView.buildMatchHero(gameState)
end

function Dashboard._buildNTSnapshot(gameState)
    return NtView.buildSnapshot(gameState)
end

function Dashboard._buildNTActivityFeed(gameState)
    return NtView.buildActivityFeed(gameState)
end

function Dashboard._skipToJobOffer(gameState)
    return NtView.skipToJobOffer(gameState)
end
