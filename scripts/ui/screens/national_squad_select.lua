    ...
    local function buildPlayerRow(p, isSelected)
        ...
        return UI.Button {
            ...
            children = {
                ...
                -- Overall
                UI.Label {
                    text = tostring(math.floor(p.overall or 0)),
                    fontSize = 14,
                    fontWeight = "bold",
                ...
                -- 年龄
                UI.Label {
                    text = tostring(math.floor(p.age or 0)),
                    fontSize = 11,
                    color = WC.TEXT_MUTED,
                    width = 28,
                    textAlign = "right",
        ...
        children = {
            ...
            UI.Panel {
                ...
                children = {
                    ...
                    UI.Label { text = "俱乐部", width = 52, fontSize = 10, color = WC.TEXT_MUTED, textAlign = "right", marginRight = 8 },
                    UI.Label { text = "能力", width = 32, fontSize = 10, color = WC.TEXT_MUTED, textAlign = "right", marginRight = 8 },
                    UI.Label { text = "年龄", width = 28, fontSize = 10, color = WC.TEXT_MUTED, textAlign = "right" },
