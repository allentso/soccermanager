...
export default function PreMatchLineup({
  userTeam, userBench, oppTeam, userColor, homeTeamColor, awayTeamColor, userSide,
  formationNeeds, selectedStarterId, isAutoSelecting,
  onSelectStarter, onSwap, onAutoSelect,
}: PreMatchLineupProps) {
        ...
        <div className="bg-navy-800 rounded-xl border border-navy-700 p-4">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex items-center gap-2">
              {selectedStarterId && (
                <button onClick={() => onSelectStarter(null)} className="text-[10px] text-gray-500 hover:text-gray-300 font-heading uppercase tracking-wider">{t('match.cancel')}</button>
              )}
