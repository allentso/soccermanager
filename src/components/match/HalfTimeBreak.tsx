        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center justify-center gap-8">
            <div className="flex items-center gap-3">
              ...
              <p className="font-heading font-bold text-gray-200">
                {snapshot.home_team.name}
              </p>
            </div>

            <div className="flex items-center gap-4">
              <span className="text-5xl font-heading font-bold text-white tabular-nums">
                {snapshot.home_score}
              </span>
          ...
          <div className="flex flex-col gap-4">
            {!isSpectator ? (
              ...
              <div className="bg-navy-800 rounded-xl border border-navy-700 p-4 flex flex-col items-center justify-center py-8">
                <p className="text-xs font-heading uppercase tracking-widest text-gray-600 mb-1">
