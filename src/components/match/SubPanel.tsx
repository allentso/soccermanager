...
export function SubPanel({
  ...
  return (
    ...
    >
      <div
        className="bg-navy-800 rounded-2xl border border-navy-600 shadow-2xl w-[1100px] max-h-[90vh] flex flex-col overflow-hidden"
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-navy-700 bg-gradient-to-r from-navy-700 to-navy-800">
          ...
          <button
            onClick={onClose}
            className="text-gray-400 hover:text-white p-1.5 rounded-lg hover:bg-navy-600 transition-colors"
          >
                      ...
                      {players.map((p) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <span className="text-[9px] text-white/70 font-medium truncate max-w-[56px]">
                              {p.name.split(" ").pop()}
                            </span>
                          </button>
                        );
                          ...
                          >
                            <td className="py-2 pr-2">
                              <div className="flex items-center gap-1.5">
                                ...
                                <span
                                  className={`font-medium truncate ${isSelected ? "text-red-300" : "text-gray-300"}`}
                                >
                                  {p.name}
                                </span>
                              </div>
            ...
            <div className="flex-1 flex flex-col">
              ...
              {selectedPlayer && comparedPlayer ? (
                <div className="mx-4 mt-3 p-3 bg-navy-700/50 rounded-xl border border-navy-600">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-[9px] text-gray-600 font-heading uppercase">
                      {t("common.vs")}
                    </span>
                    <div className="flex items-center gap-1.5">
                  ...
                  <div className="mt-3 flex items-center justify-end gap-2">
                    <button
                      ...
                      className="rounded-lg border border-navy-500 px-3 py-2 text-xs font-heading font-bold uppercase tracking-wider text-gray-300 transition-colors hover:bg-navy-600"
                    >
                      {t("common.cancel")}
                    </button>
                    <button
              ...
              {snapshot.substitutions.filter((s) => s.side === side).length >
                ...
                <div className="px-4 py-3 border-t border-navy-700">
                  <p className="text-[10px] font-heading uppercase tracking-widest text-gray-600 mb-1.5">
                    {t("match.history")}
                  </p>
                  {snapshot.substitutions
                    .filter((s) => s.side === side)
                    .map((sub, i) => (
                      ...
                      >
                        <span className="text-gray-600 tabular-nums w-5 text-right font-heading">
                          {sub.minute}'
                        </span>
