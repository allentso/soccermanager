...
- [ ] Step 2.12: Finish `ScoutingTab` container split with assignment list and player search modules.
- [ ] Step 2.13: Split `HomeTab` into smaller dashboard widgets and view-model helpers.
- [ ] Step 2.14: Refactor `TeamProfile` to reuse shared helper logic and remove duplicated formatting/domain calculations.
