...
- [ ] Step 2.3: Split `TransfersTab` into container and action panels.
- [ ] Step 2.4: Split `TrainingTab` into container, schedule/focus panels, and training-group module.
- [ ] Step 2.5: Split `ScoutingTab` into container, scout overview, assignment list, and player search modules.
- [ ] Step 2.6: Split `HomeTab` into smaller dashboard widgets and view-model helpers.
- [ ] Step 2.7: Refactor `TeamProfile` to reuse shared helper logic and remove duplicated formatting/domain calculations.
