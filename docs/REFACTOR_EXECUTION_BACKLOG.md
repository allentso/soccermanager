...
- [ ] Step 2.19: Extract `HomeTab` recent results, latest news, momentum, and inbox summary widgets to finish the container split.
- [ ] Step 2.20: Refactor `TeamProfile` to reuse shared helper logic and remove duplicated formatting/domain calculations.
